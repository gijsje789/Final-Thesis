...
\newcommand{\spacing}{\hspace{1mm}| \hspace{1mm}}
\newcommand{\invchar}{\textcolor{white}{0}}
\newcommand{\invchartwo}{\textcolor{white}{00}}
...
\DeclareAcronym{HLA}{
	short	= HLA,
	long	= Horizontal Longitudinal Axis,
	class	= abbrev
}

\DeclareAcronym{VLA}{
	short	= VLA,
	long	= Vertical Longitudinal Axis,
	class	= abbrev
}
