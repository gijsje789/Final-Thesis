...
\label{ch:res_metho}
\rrow{Define research questions}
\rrow{Discuss main research question}
\rrot{Define research boundaries}
\rrod{Define project goals}
\rrot{Implement scanner descision}
\rrot{Use limitations of phantoms to lead to research question}
