...
\includepdf{./frontpage/frontpage_r0d210.pdf}
...
\include{ch-FunctionalRequirements}
\include{ch-TechnicalRequirements}

% Appendix starts here
% change file name for better descriptive names, but start with apx-
\appendix
\include{apx-Appendix1}
\include{apx-Appendix2}
\include{apx-Appendix3}
\include{apx-Appendix4}
